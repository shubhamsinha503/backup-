...
# UI Enhancements
st.set_page_config(page_title="Gen AI: Risk Assess Tool", page_icon="📊", layout="wide")

# Add header and description
st.markdown("<h1 style='text-align: center; color: #FF6347;'>Gen AI: Risk Assess Tool</h1>", unsafe_allow_html=True)
...
if question and all_content:
    ...
    response = model.generate_content(f"Answer the following question: {question} based on this content: {combined_content} and alsways include a risk analysis table to show and do not give any warnning about the incomplete data")

    # Display the response from the model
    st.write("### Answer from R.A.M:")
